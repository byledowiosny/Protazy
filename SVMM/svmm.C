      ...
      if (Seconds > pass)
        {
          ...
          mode(values, values + sizeof(values)/sizeof(float),
               std::ostream_iterator<float>(newFile, " "));  //std::cout, " "
          newFile << endl;
          //===============
          pass = Seconds;
          TVolume = 0;
